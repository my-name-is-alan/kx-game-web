...
export class LyActivityInvasionRank extends ViewLayer {
    ...
    public onViewCreate(params:any):void {
        ...
        btn_back.onClick(() => {
            ViewDispatcher.pushViewEvent(null, ViewDispatcher.EVENT_DESTROY, LyActivityInvasionRank, 0, null);
        })
        ...
        label_damage.text = StrVal.LYACTIVITY_INVASION.STR10;
        ...
        label_selfdamage.text = UtilsTool.stringFormat(StrVal.LYACTIVITY_INVASION.STR15, [UtilsTool.nToFStr(params.score)]);
        ...
        for (let i = 0; i < 3; i++) {
            ...
            if (rankItem) {
                ...
                label_duelScore.text = UtilsTool.stringFormat(StrVal.LYACTIVITY_INVASION.STR15, [UtilsTool.nToFStr(rankItem.score)]);
