...
export class GComponent extends GObject {
    ...
    private onMaskReady() {
        ...
        if (this._maskContent instanceof GImage) {
            this._customMask.type = (<any>Mask.Type).SPRITE_STENCIL;
            ...
            if (this._maskContent.type == 2)
                this._customMask.type = (<any>Mask.Type).GRAPHICS_ELLIPSE;
            else
                this._customMask.type = (<any>Mask.Type).GRAPHICS_RECT;
        }
