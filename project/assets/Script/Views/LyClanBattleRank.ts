...
interface RankPlayer {
    ...
    appearance: number,
    dailyDuelDamage: number
    title: number
}
export class LyClanBattleRank extends ViewLayer {

    public constructor() {
        super();
        this.viewResI.resName = "LyClan";
        this.viewResI.pkgName = "LyClan";
        this.viewResI.comName = "LyClanBattleRank";
    }
    ...
    public onViewCreate(params): void {
        ...
        btn_close1.onClick(() => {
            ViewDispatcher.pushViewEvent(null, ViewDispatcher.EVENT_DESTROY, LyClanBattleRank, 0, null)
        })
        ...
        label_desc.text = StrVal.LYACTIVITY_INVASION.STR10;
        ...
        label_selfdamage.text = UtilsTool.stringFormat(StrVal.LYCLAN.STR31, [UtilsTool.nToFStr(params.dailyDuelDamage)])
        ...
        list_rank.itemRenderer = (index: number, child: fgui.GComponent) => {
            ...
            let charInfo = LocaleData.getCharShowResInfo(rankItem.character, rankItem.phase, rankItem.appearance, rankItem.model);
            ...
            label_duelScore.text = UtilsTool.nToFStr(rankItem.dailyDuelDamage);
        ...
        for (let i = 0; i < 3; i++) {
            ...
            if (rankItem) {
                ...
                label_duelScore.text = UtilsTool.stringFormat(StrVal.LYCLAN.STR25, [UtilsTool.nToFStr(rankItem.dailyDuelDamage)])
